    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="mt-0.5 text-xs text-zinc-500">
          These colours and fonts apply to the product snippet and cart you
          paste on your own site. The PaySynk hosted shop stays as it is.
        </p>
      </div>
      ...
      >
        ...
        <p className="mt-0.5 text-sm" style={{ color: previewMuted }}>
          Add to cart uses your button colour and type.
        </p>
        <button
          type="button"
          tabIndex={-1}
